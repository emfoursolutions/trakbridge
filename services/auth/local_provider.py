...
class LocalAuthProvider(BaseAuthenticationProvider):
    ...
    def __init__(self, config: Dict[str, Any] = None):
        ...
        logger.info(f"Local authentication provider initialized (registration: {self.allow_registration})")
        ...
        try:
            ...
            if self._is_password_expired(user):
                return AuthenticationResponse(
                    ...
                    details={'password_changed_at': user.password_changed_at.isoformat() if user.password_changed_at else None}
                )
    ...
    def create_user(self, username: str, password: str, email: str = None,
                   full_name: str = None, role: UserRole = None) -> User:
        """
