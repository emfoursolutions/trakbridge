...
class AuthenticationException(Exception):
    ...
    def __init__(self, message: str, result: AuthenticationResult = AuthenticationResult.UNKNOWN_ERROR, 
...
class AuthenticationResponse:
    ...
    """
    def __init__(self, result: AuthenticationResult, user: Optional[User] = None,
...
class BaseAuthenticationProvider(ABC):
    ...
    def cleanup_expired_sessions(self) -> int:
        ...
        try:
            ...
            expired_sessions = db.session.query(UserSession).join(User).filter(
