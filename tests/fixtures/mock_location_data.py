...
def generate_invalid_gps_points() -> List[Dict]:
    ...
    return [
        ...
        # Bad data types
        {"name": "BadTypes", "lat": "not_a_number", "lon": "also_not_a_number", "uid": "bad-types"},
        
        # Missing UID
        {"name": "NoUID", "lat": 45.0, "lon": -75.0},
        
        # Invalid timestamp
        {"name": "BadTimestamp", "lat": 40.0, "lon": -74.0, "uid": "bad-time", "timestamp": "not_a_date"},
    ]


def generate_mixed_valid_invalid_points(valid_count: int = 50, invalid_count: int = 5) -> List[Dict]:
    """
