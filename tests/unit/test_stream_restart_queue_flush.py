...
class TestStreamRestartQueueFlush:
    ...
    def mock_stream_manager(self, mock_db_manager):
        ...
        with patch('services.stream_manager.DatabaseManager', return_value=mock_db_manager), \
    ...
    async def test_restart_stream_single_server_queue_flush(
        ...
        mock_stream_manager.db_manager.get_stream_with_relationships.return_value = mock_stream_single_server
    ...
    async def test_restart_stream_multi_server_queue_flush(
        ...
        # Mock database call to return our test stream
        mock_stream_manager.db_manager.get_stream_with_relationships.return_value = mock_stream_multi_server
    ...
    async def test_restart_stream_no_tak_servers_configured(
        ...
        mock_stream_manager.db_manager.get_stream_with_relationships.return_value = stream_no_servers
    ...
    async def test_restart_stream_database_error_continues_restart(
        ...
        # Mock database error
        mock_stream_manager.db_manager.get_stream_with_relationships.side_effect = Exception("DB Error")
