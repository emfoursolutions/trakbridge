...
"""
    ...
    def test_local_config_priority_in_development(self):
        ...
        self.assertEqual(config['authentication']['providers']['local']['password_policy']['min_length'], 4)
    ...
    def test_template_config_with_environment_variables(self):
        ...
        self.assertEqual(config['authentication']['providers']['ldap']['server'], 'ldap://ci-test.com')
        self.assertEqual(config['authentication']['providers']['ldap']['bind_dn'], 'cn=citest,dc=test,dc=com')
        self.assertEqual(config['authentication']['providers']['ldap']['bind_password'], 'ci-secret')
    ...
    def test_template_with_defaults(self):
        ...
        self.assertEqual(config['authentication']['providers']['ldap']['server'], 'ldap.example.com')
