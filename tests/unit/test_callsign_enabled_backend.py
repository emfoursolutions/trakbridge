...
class TestCallsignEnabledBackend:
    ...
    def test_create_callsign_mappings_handles_enabled_true(
        self, operations_service, mock_session, mock_stream
    ):
        ...
        with patch.object(
            operations_service, "_get_session", return_value=mock_session
        ):
    ...
    def test_create_callsign_mappings_handles_enabled_false(
        self, operations_service, mock_session, mock_stream
    ):
    ...
    def test_create_callsign_mappings_handles_mixed_enabled_states(
        self, operations_service, mock_session, mock_stream
    ):
    ...
    def test_create_callsign_mappings_handles_json_boolean(
        self, operations_service, mock_session, mock_stream
    ):
    ...
    def test_create_callsign_mappings_allows_empty_callsign_for_disabled(
        self, operations_service, mock_session, mock_stream
    ):
    ...
    def test_create_callsign_mappings_skips_missing_identifier(
        self, operations_service, mock_session, mock_stream
    ):
    ...
    def test_update_callsign_mappings_preserves_enabled_field(
        self, operations_service, mock_session, mock_stream
    ):
...
class TestEnabledFieldValidation:
    ...
    def test_enabled_field_string_variations(
        self, operations_service, mock_session, mock_stream
    ):
        ...
        for enabled_value, expected_result in test_cases:
            with patch.object(
                ...
                created_mapping = mock_session.add.call_args[0][0]
                assert (
                    created_mapping.enabled is expected_result
                ), f"Failed for value '{enabled_value}'"

                # Reset for next iteration
                mock_session.reset_mock()

    def test_enabled_field_none_defaults_to_false(
        self, operations_service, mock_session, mock_stream
    ):
