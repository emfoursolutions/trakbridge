...
class TestMultiServerDistribution:
    ...
    def test_single_fetch_multiple_server_distribution(self):
        ...
        test_locations = [
            {"uid": "device1", "lat": 40.7128, "lon": -74.0060, "name": "Test Device 1"},
            {"uid": "device2", "lat": 34.0522, "lon": -118.2437, "name": "Test Device 2"},
        ]
    ...
    def test_api_call_reduction(self):
        ...
        plugin = Mock()
        plugin.fetch_locations = AsyncMock(return_value=[
    ...
    def test_distribution_maintains_data_integrity(self):
        ...
        with pytest.raises((NotImplementedError, AttributeError)):
            ...
            worker._validate_distribution_integrity(original_locations, [server1, server2])
