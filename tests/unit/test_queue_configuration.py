"""
ABOUTME: Unit tests for queue configuration loading, validation, and environment variable handling
...
class TestQueueConfigurationLoading:
    ...
    def test_default_configuration_values(self):
        ...
        with patch('builtins.open', side_effect=FileNotFoundError):
            ...
            assert config['queue']['batch_size'] == expected_defaults['queue']['batch_size']
            assert config['queue']['overflow_strategy'] == expected_defaults['queue']['overflow_strategy']
            assert config['queue']['flush_on_config_change'] == expected_defaults['queue']['flush_on_config_change']
...
"""
        ...
        with patch('builtins.open', mock_open(read_data=yaml_config)):
            ...
            assert config['queue']['flush_on_config_change'] == False
    ...
    def test_environment_variable_override(self):
        ...
        with patch.dict(os.environ, env_vars, clear=False):
            ...
            assert config['monitoring']['log_queue_stats'] == False
...
class TestQueueConfigurationValidation:
    ...
    def test_configuration_auto_correction(self):
        ...
        assert corrected_config['queue']['overflow_strategy'] in ['drop_oldest', 'drop_newest', 'block']
...
class TestConfigurationPrecedence:
    ...
    def test_deep_configuration_merging(self):
        ...
        assert merged_config['monitoring']['log_queue_stats'] == True    # Added
    ...
    def test_environment_variable_type_conversion(self):
        ...
        with patch.dict(os.environ, env_vars, clear=False):
            ...
            assert config['queue']['flush_on_config_change'] == True
...
class TestConfigurationFileDiscovery:
    ...
    def test_configuration_file_search_order(self):
        ...
        for expected_path in expected_search_paths:
            assert any(expected_path in path for path in search_paths), f"Missing search path: {expected_path}"
