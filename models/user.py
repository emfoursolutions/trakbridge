...
# Third-party imports
import bcrypt
from sqlalchemy import Boolean, Column, DateTime, Enum as SQLEnum, Integer, String, Text, ForeignKey
...
class User(db.Model, TimestampMixin):
    ...
    @classmethod
    def create_local_user(cls, username: str, password: str, email: str = None, 
    ...
    @classmethod
    def create_external_user(cls, username: str, provider: AuthProvider, 
                           provider_user_id: str, provider_data: Dict[str, Any] = None,
