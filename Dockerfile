...
# Create the _version.py file manually
version_file = Path('_version.py')
version_content = f'''# coding: utf-8
# file generated by setuptools_scm
# don't change, don't track in version control
__version__ = version = \"{version}\"
__version_tuple__ = version_tuple = {setuptools_scm.version.format_version(setuptools_scm.get_version(), version_scheme='guess-next-dev', local_scheme='node-and-date')}
'''
