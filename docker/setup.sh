...
-- CREATE DATABASE gps_tak_app_test;
...
GRANT ALL PRIVILEGES ON DATABASE gps_tak_app TO postgres;
EOF
...
ALTER DATABASE gps_tak_app CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;

-- Create additional databases if needed
-- CREATE DATABASE gps_tak_app_test CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;

-- Grant permissions
GRANT ALL PRIVILEGES ON gps_tak_app.* TO 'mysql'@'%';
FLUSH PRIVILEGES;
EOF
